...
class DemoGame : public app::GameInterface {
 public:
  void onStart(world::World& world, world::Scene& scene, app::InputSystem& input,
               physics::World& physics) override {
    // Build initial scene/entities here.
  }

  void onFixedUpdate(world::World& world, world::Scene& scene, app::InputSystem& input,
                     physics::World& physics, float dt) override {
    // Deterministic simulation step.
  }

  void onUpdate(world::World& world, world::Scene& scene, app::InputSystem& input,
                physics::World& physics, float dt) override {
