...
class CollisionEventsGame final : public app::GameInterface {
 public:
  ...
  void onStart() override {
    ...
    world->add(player_entity_, components::BoxColliderComponent{
        .center = {0.0f, 0.0f, 0.0f},
        .half_extents = {1.0f, 1.0f, 1.0f}});
    world->add(player_entity_, components::PlayerControllerComponent{});
 ...
 private:
  void createTriggerZone(std::string name,
    ...
    components::SphereColliderComponent collider{};
