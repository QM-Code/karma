...
constexpr uint16_t kFlagWater = 1u << 4u;
constexpr uint16_t kFlagDoor = 1u << 5u;
constexpr uint16_t kFlagDisabled = 1u << 6u;
constexpr unsigned char kAreaWater = 2;
constexpr unsigned char kAreaDoor = 3;
