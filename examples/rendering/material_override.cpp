...
class MaterialOverrideExample final : public app::GameInterface {
 public:
  void onStart() override {
    ...
    registerTintMaterial(*materials, "tank_red", math::Color{1.0f, 0.35f, 0.30f, 1.0f});
    registerTintMaterial(*materials, "tank_blue", math::Color{0.35f, 0.55f, 1.0f, 1.0f});
    registerTintMaterial(*materials, "tank_gold", math::Color{1.0f, 0.82f, 0.35f, 1.0f});
