...
/// Jolt implementation of `PhysicsCharacterControllerBackend`.
class PhysicsCharacterControllerJolt final : public PhysicsCharacterControllerBackend {
public:
    PhysicsCharacterControllerJolt(PhysicsWorldJolt* world,
                                const glm::vec3& halfExtents,
                                const glm::vec3& startPosition);
    ~PhysicsCharacterControllerJolt() override;
